...
var qq = function (a) {
    ...
    return {
        ...
        addClass: function (b) {
            return qq(a).hasClass(b) || (a.className += " " + b),
                this
        },
        removeClass: function (b) {
            var c = new RegExp("(^| )" + b + "( |$)");
            return a.className = a.className.replace(c, " ").replace(/^\s+|\s+$/g, ""),
                this
        },
...
!function () {
    ...
    qq.log = function (a, b) {
        ...
        qq.isXhrUploadSupported = function () {
            ...
            return a.type = "file",
                void 0 !== a.multiple && "undefined" != typeof File && "undefined" != typeof FormData && "undefined" != typeof qq.createXhrInstance().upload
        }
        ,
        qq.createXhrInstance = function () {
            ...
            try {
                ...
                return qq.log("Neither XHR or ActiveX are supported!", "error"),
                    null
            }
        }
        ,
        ...
        qq.extend = function (a, b, c) {
            return qq.each(b, function (b, d) {
                c && qq.isObject(d) ? (void 0 === a[b] && (a[b] = {}),
                    qq.extend(a[b], d, !0)) : a[b] = d
            }),
                a
        }
        ,
        ...
        qq.each = function (a, b) {
            ...
            if (a)
                if (window.Storage && a.constructor === window.Storage)
                    for (c = 0; c < a.length && (d = b(a.key(c), a.getItem(a.key(c))),
                        d !== !1); c++)
                        ;
                else if (qq.isArray(a) || qq.isItemList(a) || qq.isNodeList(a))
                    for (c = 0; c < a.length && (d = b(c, a[c]),
                        d !== !1); c++)
                        ;
                else if (qq.isString(a))
                    for (c = 0; c < a.length && (d = b(c, a.charAt(c)),
                        d !== !1); c++)
                        ;
                else
                    for (c in a)
                        if (Object.prototype.hasOwnProperty.call(a, c) && (d = b(c, a[c]),
                            d === !1))
                            break
        }
        ,
        ...
        qq.obj2url = function (a, b, c) {
            ...
            return !c && b ? (e = /\?/.test(b) ? /\?$/.test(b) ? "" : "&" : "?",
                ...
                b ? d.join(e) : d.join(e).replace(/^&/, "").replace(/%20/g, "+")
        }
        ,
        qq.obj2FormData = function (a, b, c) {
            return b || (b = new FormData),
        ...
        qq.obj2Inputs = function (a, b) {
            var c;
            return b || (b = document.createElement("form")),
                qq.obj2FormData(a, {
                    append: function (a, d) {
        ...
        qq.setCookie = function (a, b, c) {
            var d = new Date
                , e = "";
            c && (d.setTime(d.getTime() + 24 * c * 60 * 60 * 1e3),
        ...
        qq.getCookie = function (a) {
            ...
            return qq.each(d, function (a, d) {
                ...
                return 0 === e.indexOf(c) ? (b = e.substring(c.length, e.length),
                    !1) : void 0
            }),
                b
        }
        ...
        qq.areCookiesEnabled = function () {
            var a = 1e5 * Math.random()
                , b = "qqCookieTest:" + a;
            return qq.setCookie(b, 1),
                qq.getCookie(b) ? (qq.deleteCookie(b),
                    !0) : !1
        }
        ,
    ...
    qq.supportedFeatures = function () {
        ...
        return h = a(),
            i = h && qq.isXhrUploadSupported(),
            j = i && b(),
            k = i && qq.isFileChunkingSupported(),
            l = i && k && qq.areCookiesEnabled(),
            m = i && c(),
            n = h && (void 0 !== window.postMessage || i),
            p = d(),
            o = e(),
            q = f(),
            r = g(),
            s = i && void 0 !== window.FileReader,
        {
            uploading: h,
            ajaxUploading: i,
            fileDrop: i,
    ...
    qq.Promise = function () {
        ...
        qq.extend(this, {
            then: function (e, g) {
                return 0 === f ? (e && c.push(e),
                    g && d.push(g)) : -1 === f ? g && g.apply(null, b) : e && e.apply(null, a),
                    this
            },
            done: function (c) {
                return 0 === f ? e.push(c) : c.apply(null, void 0 === b ? a : b),
                    this
            },
            success: function () {
                return f = 1,
                    a = arguments,
                    c.length && qq.each(c, function (b, c) {
                        c.apply(null, a)
                    }),
            ...
            failure: function () {
                return f = -1,
                    b = arguments,
                    d.length && qq.each(d, function (a, c) {
                        c.apply(null, b)
                    }),
    ...
    qq.UploadButton = function (a) {
        ...
        function b() {
            ...
            return a.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, d),
                f.multiple && a.setAttribute("multiple", ""),
                f.folders && qq.supportedFeatures.folderSelection && a.setAttribute("webkitdirectory", ""),
                f.acceptFiles && a.setAttribute("accept", f.acceptFiles),
                a.setAttribute("type", "file"),
                a.setAttribute("name", f.name),
                qq(a).css({
                    position: "absolute",
                    right: 0,
                    top: 0,
    ...
    function () {
        ...
        qq.basePublicApi = {
            ...
            addFiles: function (a, b, c) {
                var d, e, f, g = [];
                if (a) {
                    for (qq.isFileList(a) || (a = [].concat(a)),
                        d = 0; d < a.length; d += 1)
                        if (e = a[d],
                            qq.isFileOrInput(e))
                    ...
                    this.log("Received " + g.length + " files or inputs."),
                        this._prepareItemsForUpload(g, b, c)
                }
            },
            addBlobs: function (a, b, c) {
                if (a) {
                    ...
                    qq.each(d, function (a, b) {
                        ...
                        } : qq.isObject(b) && b.blob && b.name ? c = b : f.log("addBlobs: entry at index " + a + " is not a Blob or a BlobData object", "error"),
                            c && f._handleNewFile(c, e)
                    }),
            ...
            drawThumbnail: function (a, b, c, d) {
                if (this._imageGenerator) {
                    ...
                    return !d && qq.supportedFeatures.imagePreviews && (e = this.getFile(a)),
                        null == e ? (new qq.Promise).failure(b, "File or URL not found.") : this._imageGenerator.generate(e, b, f)
                }
            },
            pauseUpload: function (a) {
                ...
                if (qq.indexOf([qq.status.UPLOADING, qq.status.UPLOAD_RETRYING], b.status) >= 0) {
                    if (this._handler.pause(a))
                        return this._uploadData.setStatus(a, qq.status.PAUSED),
                            !0;
            ...
            continueUpload: function (a) {
                ...
                return qq.supportedFeatures.pause && this._options.chunking.enabled ? b.status === qq.status.PAUSED ? (qq.log(qq.format("Paused file ID {} ({}) will be continued.  Not paused.", a, this.getName(a))),
                    this._uploadFile(a),
                    !0) : (qq.log(qq.format("Ignoring continue for file ID {} ({}).  Not paused.", a, this.getName(a)), "error"),
                        !1) : !1
            },
            ...
            qq.basePrivateApi = {
                ...
                _refreshSessionData: function () {
                    ...
                    qq.Session && null != this._options.session.endpoint && (this._session || (qq.extend(b, this._options.cors),
                        b.log = qq.bind(this.log, this),
                        b.addFileRecord = qq.bind(this._addCannedFile, this),
                        this._session = new qq.Session(b)),
                        setTimeout(function () {
                ...
                _addCannedFile: function (a) {
                    ...
                    return a.deleteFileEndpoint && this.setDeleteFileEndpoint(a.deleteFileEndpoint, b),
                        a.deleteFileParams && this.setDeleteFileParams(a.deleteFileParams, b),
                        a.thumbnailUrl && (this._thumbnailUrls[b] = a.thumbnailUrl),
                        this._netUploaded++,
                ...
                _handleNewFile: function (a, b) {
                    ...
                    a.size >= 0 ? d = a.size : a.blob && (d = a.blob.size),
                        c = this._uploadData.addFile(e, f, d),
                        this._handler.add(c, a),
                        this._netUploadedOrQueued++,
                        b.push({
                            id: c,
                            file: a
                ...
                _generateExtraButtonSpecs: function () {
                    ...
                    this._extraButtonSpecs = {},
                        qq.each(this._options.extraButtons, function (b, c) {
                            var d = c.multiple
                                , e = qq.extend({}, a._options.validation, !0)
                                , f = qq.extend({}, c);
                            void 0 === d && (d = a._options.multiple),
                                f.validation && qq.extend(e, c.validation, !0),
                                qq.extend(f, {
                                    multiple: d,
                                    validation: e
                                }, !0),
                                a._initExtraButton(f)
                        })
                },
                ...
                _getButtonId: function (a) {
                    ...
                    if (a && !a.blob && !qq.isBlob(a)) {
                        ...
                        if (b = a.getElementsByTagName("input"),
                            qq.each(b, function (a, b) {
                                return "file" === b.getAttribute("type") ? (c = b,
                                    !1) : void 0
                            }),
                            c)
                ...
                _handleCheckedCallback: function (a) {
                    var b = this
                        , c = a.callback();
                    return c instanceof qq.Promise ? (this.log(a.name + " - waiting for " + a.name + " promise to be fulfilled for " + a.identifier),
                        c.then(function (c) {
                            b.log(a.name + " promise success for " + a.identifier),
                                a.onSuccess(c)
                        }, function () {
                            a.onFailure ? (b.log(a.name + " promise failure for " + a.identifier),
                                a.onFailure()) : b.log(a.name + " promise failure for " + a.identifier)
                    ...
                    var c = this
                        , d = {
                            ...
                            onProgress: function (a, b, d, e) {
                                c._onProgress(a, b, d, e),
                                    c._options.callbacks.onProgress(a, b, d, e)
                            },
                            ...
                            onUpload: function (a, b) {
                                c._onUpload(a, b),
                                    c._options.callbacks.onUpload(a, b)
                            },
                            onUploadChunk: function (a, b, d) {
                                c._onUploadChunk(a, d),
                ...
                _preventLeaveInProgress: function () {
                    ...
                    this._disposeSupport.attach(window, "beforeunload", function (b) {
                        return a.getInProgress() ? (b = b || window.event,
                ...
                _onComplete: function (a, b, c, d) {
                    return c.success ? (c.thumbnailUrl && (this._thumbnailUrls[a] = c.thumbnailUrl),
                        this._netUploaded++,
                        this._uploadData.setStatus(a, qq.status.UPLOAD_SUCCESSFUL)) : (this._netUploadedOrQueued--,
                            this._uploadData.setStatus(a, qq.status.UPLOAD_FAILED)),
                ...
                _onCancel: function (a) {
                    ...
                    !this._options.autoUpload && b >= 0 && this._storedIds.splice(b, 1),
                ...
                _onSubmitDelete: function (a, b, c) {
                    ...
                    return b && (d = qq.bind(b, this, a, e, c)),
                        this._isDeletePossible() ? this._handleCheckedCallback({
                            name: "onSubmitDelete",
                ...
                _onDeleteComplete: function (a, b, c) {
                    ...
                    c ? (this._uploadData.setStatus(a, qq.status.DELETE_FAILED),
                        this.log("Delete request for '" + d + "' has failed.", "error"),
                        void 0 === b.withCredentials ? this._options.callbacks.onError(a, d, "Delete request failed", b) : this._options.callbacks.onError(a, d, "Delete request failed with response code " + b.status, b)) : (this._netUploadedOrQueued--,
                            ...
                            this._uploadData.setStatus(a, qq.status.DELETED),
                ...
                _onAutoRetry: function (a, b, c, d, e) {
                    ...
                    return f._preventRetries[a] = c[f._options.retry.preventRetryResponseProperty],
                        f._shouldAutoRetry(a, b, c) ? (f._maybeParseAndSendUploadError.apply(f, arguments),
                            f._options.callbacks.onAutoRetry(a, b, f._autoRetries[a] + 1),
                            f._onBeforeAutoRetry(a, b),
                            f._retryTimeouts[a] = setTimeout(function () {
                                f.log("Retrying " + b + "..."),
                                    f._autoRetries[a]++,
                                    f._uploadData.setStatus(a, qq.status.UPLOAD_RETRYING),
                                    e ? e(a) : f._handler.retry(a)
                            }, 1e3 * f._options.retry.autoAttemptDelay),
                            !0) : void 0
                },
                ...
                _onBeforeManualRetry: function (a) {
                    ...
                    if (this._preventRetries[a])
                        return this.log("Retries are forbidden for id " + a, "warn"),
                            !1;
                    if (this._handler.isValid(a)) {
                        ...
                        return this._options.callbacks.onManualRetry(a, c) === !1 ? !1 : b > 0 && this._netUploadedOrQueued + 1 > b ? (this._itemError("retryFailTooManyItems"),
                            !1) : (this.log("Retrying upload for '" + c + "' (id: " + a + ")..."),
                                !0)
                    }
                    return this.log("'" + a + "' is not a valid file ID", "error"),
                        !1
                },
                _manualRetry: function (a, b) {
                    return this._onBeforeManualRetry(a) ? (this._netUploadedOrQueued++,
                        this._uploadData.setStatus(a, qq.status.UPLOAD_RETRYING),
                        b ? b(a) : this._handler.retry(a),
                        !0) : void 0
                },
                ...
                _onValidateCallbackSuccess: function (a, b, c, d) {
                    var e = this
                        , f = b + 1
                        , g = this._getValidationDescriptor(a[b].file);
                    this._validateFileOrBlobData(a[b], g).then(function () {
                        e._upload(a[b].id, c, d),
                            e._maybeProcessNextItemAfterOnValidateCallback(!0, a, f, c, d)
                    }, function () {
                ...
                _onValidateCallbackFailure: function (a, b, c, d) {
                    var e = b + 1;
                    this._fileOrBlobRejected(a[0].id, a[0].file.name),
                        this._maybeProcessNextItemAfterOnValidateCallback(!1, a, e, c, d)
                },
                ...
                _validateFileOrBlobData: function (a, b) {
                    ...
                    return i.then(function () { }, function () {
                        ...
                        qq.isFileOrInput(d) && !this._isAllowedExtension(h.allowedExtensions, e) ? (this._itemError("typeError", e, d),
                            i.failure()) : 0 === f ? (this._itemError("emptyError", e, d),
                                i.failure()) : f && h.sizeLimit && f > h.sizeLimit ? (this._itemError("sizeError", e, d),
                                    i.failure()) : f && f < h.minSizeLimit ? (this._itemError("minSizeError", e, d),
                ...
                _fileOrBlobRejected: function (a) {
                    this._netUploadedOrQueued--,
                        this._uploadData.setStatus(a, qq.status.REJECTED)
                },
                _itemError: function (a, b, c) {
                    ...
                    return qq.each(l.allowedExtensions, function (a, b) {
                        ...
                        e = h.join(", ").toLowerCase(),
                        d("{file}", this._options.formatFileName(j)),
                        d("{extensions}", e),
                        d("{sizeLimit}", this._formatSize(l.sizeLimit)),
                        d("{minSizeLimit}", this._formatSize(l.minSizeLimit)),
                        f = g.match(/(\{\w+\})/g),
                        null !== f && qq.each(f, function (a, b) {
                            d(b, i[a])
                        }),
                        this._options.callbacks.onError(null, j, g, void 0),
                        g
                },
                ...
                _parseFileOrBlobDataSize: function (a) {
                    var b;
                    return qq.isFileOrInput(a) ? void 0 === a.value && (b = null !== a.fileSize && void 0 !== a.fileSize ? a.fileSize : a.size) : b = a.blob.size,
                        b
                },
                _getValidationDescriptor: function (a) {
                    var b = {}
                        , c = this._parseFileOrBlobDataName(a)
                        , d = this._parseFileOrBlobDataSize(a);
                    return b.name = c,
                        void 0 !== d && (b.size = d),
                        b
                },
                ...
                _createParamsStore: function (a) {
                    ...
                    return {
                        ...
                        getParams: function (d) {
                            var e = {};
                            return null != d && b[d] ? qq.extend(e, b[d]) : qq.extend(e, c._options[a].params),
                                e
                        },
                        remove: function (a) {
                            return delete b[a]
                ...
                _handleCameraAccess: function () {
                    if (this._options.camera.ios && qq.ios()) {
                        var a = "image/*;capture=camera"
                            ...
                            , d = this._options;
                        c && c !== this._defaultButtonId && (d = this._extraButtonSpecs[c]),
                            d.multiple = !1,
                            null === d.validation.acceptFiles ? d.validation.acceptFiles = a : d.validation.acceptFiles += "," + a,
                            qq.each(this._buttons, function (a, b) {
                                return b.getButtonId() === c ? (b.setMultiple(d.multiple),
                                    b.setAcceptFiles(d.acceptFiles),
                                    !1) : void 0
                            })
                    }
                },
    ...
    function () {
        ...
        qq.FineUploaderBasic = function (a) {
            this._options = {
                ...
                this._options.paste.targetElement && (qq.PasteSupport ? this._pasteHandler = this._createPasteHandler() : qq.log("Paste support module not found", "info")),
    ...
    qq.AjaxRequester = function (a) {
        ...
        function e() {
            ...
            return (window.XMLHttpRequest || window.ActiveXObject) && (a = qq.createXhrInstance(),
                void 0 === a.withCredentials && (a = new XDomainRequest)),
                a
        }
        function f(a, b) {
            var c = u[a].xhr;
            return c || b || (c = v.cors.expected ? e() : qq.createXhrInstance(),
                u[a].xhr = c),
                c
        }
        function g(a) {
        ...
        function h(a, b) {
            var c = f(a)
                ...
                , h = b === !0;
            g(a),
                h ? r(e + " request for " + a + " has failed", "error") : d(c) || p(c.status) || (h = !0,
                    r(e + " request for " + a + " has failed - response code " + c.status, "error")),
                v.onComplete(a, c, h)
        }
        function i(a) {
            var b, c = u[a].additionalParams, d = v.mandatedParams;
            return v.paramsStore.getParams && (b = v.paramsStore.getParams(a)),
                c && qq.each(c, function (a, c) {
                    b = b || {},
                        b[a] = c
                }),
        ...
        function j(a) {
            ...
            v.onSend(a),
                b = k(a, g),
                d(c) ? (c.onload = m(a),
                    c.onerror = n(a)) : c.onreadystatechange = l(a),
                c.open(e, b, !0),
                v.cors.expected && v.cors.sendCredentials && !d(c) && (c.withCredentials = !0),
                o(a),
                r("Sending " + e + " request for " + a),
                h ? c.send(h) : s || !g ? c.send() : c.send(g && v.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >= 0 ? qq.obj2url(g, "") : g && v.contentType.toLowerCase().indexOf("application/json") >= 0 ? JSON.stringify(g) : g)
        }
        function k(a, b) {
            var c = v.endpointStore.getEndpoint(a)
                , d = u[a].addToPath;
            return void 0 != d && (c += "/" + d),
                s && b ? qq.obj2url(b, c) : c
        }
        function l(a) {
            return function () {
        ...
        function o(a) {
            var e = f(a)
                , g = v.customHeaders
                , h = u[a].additionalHeaders || {}
                , i = v.method
                , j = {};
            d(e) || (v.allowXRequestedWithAndCacheControl && (v.cors.expected && b() && !c(g) || (e.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                e.setRequestHeader("Cache-Control", "no-cache"))),
                !v.contentType || "POST" !== i && "PUT" !== i || e.setRequestHeader("Content-Type", v.contentType),
                qq.extend(j, g),
                qq.extend(j, h),
                qq.each(j, function (a, b) {
        ...
        if (qq.extend(v, a),
            r = v.log,
            qq.indexOf(v.validMethods, v.method) < 0)
            throw new Error("'" + v.method + "' is not a supported method for this type of request!");
        s = "GET" === v.method || "DELETE" === v.method,
            qq.extend(this, {
    ...
    qq.UploadHandler = function (a, b) {
        ...
        function c(a) {
            ...
            c >= 0 && (i.splice(c, 1),
                i.length >= d && d > c && (b = i[d - 1],
                    h.upload(b)))
        }
        function d(a) {
            g("Cancelling " + a),
                f.paramsStore.remove(a),
                c(a)
        }
        function e() {
            var a = b ? qq[b] : qq
        ...
        f = {
            ...
            qq.extend(this, {
                ...
                upload: function (a) {
                    var b = i.push(a);
                    return b <= f.maxConnections ? (h.upload(a),
                        !0) : !1
                },
                retry: function (a) {
                ...
                pause: function (a) {
                    return h.pause && this.isValid(a) && h.pause(a) ? (c(a),
                        !0) : void 0
                }
            }),
            e()
    ...
    ,
    qq.UploadHandlerFormApi = function (a, b, c) {
        "use strict";
        function d(b) {
            delete j[b],
                delete m[b],
                l && (clearTimeout(k[b]),
                    delete k[b],
                    t.stopReceivingMessages(b));
            var c = document.getElementById(a.getIframeName(b));
            c && (c.setAttribute("src", "java" + String.fromCharCode(115) + "cript:false;"),
                qq(c).remove())
        }
        function e(b, c) {
            var d = b.id
                ...
                , f = r(e);
            i[f] = c,
                j[e] = qq(b).attach("load", function () {
                    m[e].input && (s("Received iframe load event for CORS upload request (iframe name " + d + ")"),
                ...
                t.receiveMessage(d, function (b) {
                    s("Received the following window message: '" + b + "'");
                    var c, e = g(d), f = a.parseJsonResponse(e, b), h = f.uuid;
                    h && i[h] ? (s("Handling response for iframe name " + d),
                        clearTimeout(k[d]),
                        delete k[d],
                        a.detachLoadEvent(d),
                        c = i[h],
                        delete i[h],
                        t.stopReceivingMessages(d),
                        c(f)) : h || s("'" + b + "' does not contain a UUID - ignoring.")
                })
        }
        function f(a) {
            var b = qq.toElement("<iframe src='javascript:false;' name='" + a + "' />");
            return b.setAttribute("id", a),
        ...
        qq.extend(a, {
            ...
            parseJsonResponse: function (a, b) {
                ...
                try {
                    c = qq.parseJson(b),
                        void 0 !== c.newUuid && p(a, c.newUuid)
                } catch (d) {
                    s("Error when attempting to parse iframe upload response (" + d.message + ")", "error"),
                        c = {}
                }
                return c
            },
            initFormForUpload: function (a) {
                var b = a.method
                    ...
                    , h = c;
                return e ? qq.obj2Inputs(d, g) : h = qq.obj2url(d, c),
                    g.setAttribute("action", h),
                    g.setAttribute("target", f),
            ...
            attachLoadEvent: function (a, b) {
                var c;
                l ? e(a, b) : j[a.id] = qq(a).attach("load", function () {
                    if (s("Received response for " + a.id),
                        a.parentNode) {
                        try {
                            if (a.contentDocument && a.contentDocument.body && "false" == a.contentDocument.body.innerHTML)
                                return
                        } catch (d) {
                            s("Error when attempting to access iframe during handling of upload response (" + d.message + ")", "error"),
                                c = {
                                    success: !1
                                }
                        }
            ...
            qq.extend(this, {
                add: function (a, b) {
                    m[a] = {
                        ...
                        b.parentNode && qq(b).remove()
                },
                getInput: function (a) {
                    return m[a].input
                },
                isValid: function (a) {
                    return void 0 !== m[a] && void 0 !== m[a].input
                },
                reset: function () {
                    m.length = 0
                },
    ...
    ,
    qq.UploadHandlerXhrApi = function (a, b, c) {
        "use strict";
        function d(a, b, c) {
        ...
        qq.extend(a, {
            ...
            getChunkData: function (b, c) {
                var f = g.partSize
                    , h = k(b)
                    , i = e.getFile(b)
                    , j = f * c
                    , l = j + f >= h ? h : j + f
                    , m = a.getTotalChunks(b);
                return {
                    part: c,
                    start: j,
                    end: l,
            ...
            qq.extend(this, {
                ...
                getFile: function (a) {
                    return f[a] ? f[a].file || f[a].blobData.blob : void 0
                },
                isValid: function (a) {
                    return void 0 !== f[a]
                },
                ...
                pause: function (a) {
                    var b = f[a].xhr;
                    return b ? (l(qq.format("Aborting XHR upload for {} '{}' due to pause instruction.", a, j(a))),
                        f[a].paused = !0,
                        b.abort(),
                        !0) : void 0
                }
        ...
        qq.uiPublicApi = {
            ...
            reset: function () {
                this._parent.prototype.reset.apply(this, arguments),
                    ...
                    !this._options.button && this._templating.getButton() && (this._defaultButtonId = this._createUploadButton({
                        element: this._templating.getButton()
                    }).getButtonId()),
                    this._dnd && (this._dnd.dispose(),
            ...
            pauseUpload: function (a) {
                ...
                return b && this._templating.uploadPaused(a),
                    b
            },
            continueUpload: function (a) {
                var b = this._parent.prototype.continueUpload.apply(this, arguments);
                return b && this._templating.uploadContinued(a),
                    b
            },
            getId: function (a) {
            ...
            qq.uiPrivateApi = {
                _getButton: function (a) {
                    ...
                    return b || a === this._defaultButtonId && (b = this._templating.getButton()),
                        b
                },
                ...
                _setupClickAndEditEventHandlers: function () {
                    this._fileButtonsClickHandler = qq.FileButtonsClickHandler && this._bindFileButtonsClickEvent(),
                        ...
                        this._isEditFilenameEnabled() && (this._filenameClickHandler = this._bindFilenameClickEvent(),
                        ...
                        new qq.DragAndDrop({
                            ...
                            callbacks: {
                                ...
                                processingDroppedFilesComplete: function (b, d) {
                                    c.hideDropProcessing(),
                                        qq.each(b, function (a, b) {
                                            b.qqDropTarget = d
                                        }),
                                        b && a.addFiles(b, null, null)
                                },
                ...
                _bindFileButtonsClickEvent: function () {
                    ...
                    return new qq.FileButtonsClickHandler({
                        ...
                        onRetry: function (b) {
                            qq(a._templating.getFileContainer(b)).removeClass(a._classes.retryable),
                                a.retry(b)
                        },
                        onPause: function (b) {
                            a.pauseUpload(b)
                ...
                _filenameEditHandler: function () {
                    ...
                    return {
                        ...
                        onSetName: function (c, d) {
                            ...
                            b.updateFilename(c, e),
                                a.setName(c, d)
                        },
                        onEditingStatusChange: function (a, c) {
                            var d = qq(b.getEditInput(a))
                                , e = qq(b.getFileContainer(a));
                            c ? (d.addClass("qq-editing"),
                                b.hideFilename(a),
                                b.hideEditIcon(a)) : (d.removeClass("qq-editing"),
                                    b.showFilename(a),
                                    b.showEditIcon(a)),
                                e.addClass("qq-temp").removeClass("qq-temp")
                        }
                    }
                },
                _onUploadStatusChange: function (a, b, c) {
                    this._parent.prototype._onUploadStatusChange.apply(this, arguments),
                        this._isEditFilenameEnabled() && this._templating.getFileContainer(a) && c !== qq.status.SUBMITTED && (this._templating.markFilenameEditable(a),
                ...
                _storeForLater: function (a) {
                    this._parent.prototype._storeForLater.apply(this, arguments),
                        this._templating.hideSpinner(a)
                },
                ...
                _onSubmitted: function (a) {
                    this._isEditFilenameEnabled() && (this._templating.markFilenameEditable(a),
                        this._templating.showEditIcon(a),
                        this._focusinEventSupported || this._filenameInputFocusHandler.addHandler(this._templating.getEditInput(a)))
                },
                _onProgress: function (a, b, c, d) {
                    this._parent.prototype._onProgress.apply(this, arguments),
                        this._templating.updateProgress(a, c, d),
                        c === d ? (this._templating.hideCancel(a),
                            this._templating.hidePause(a),
                            this._templating.setStatusText(a, this._options.text.waitingForResponse),
                            this._displayFileSize(a)) : this._displayFileSize(a, c, d)
                },
                _onComplete: function (a, b, c) {
                    function d(b) {
                        f.setStatusText(a),
                            qq(f.getFileContainer(a)).removeClass(g._classes.retrying),
                            f.hideProgress(a),
                            (!g._options.disableCancelForFormUploads || qq.supportedFeatures.ajaxUploading) && f.hideCancel(a),
                            f.hideSpinner(a),
                            b.success ? g._markFileAsSuccessful(a) : (qq(f.getFileContainer(a)).addClass(g._classes.fail),
                                g._templating.isRetryPossible() && !g._preventRetries[a] && qq(f.getFileContainer(a)).addClass(g._classes.retryable),
                                g._controlFailureTextDisplay(a, b))
                    }
                ...
                _markFileAsSuccessful: function (a) {
                    ...
                    this._isDeletePossible() && b.showDeleteButton(a),
                        qq(b.getFileContainer(a)).addClass(this._classes.success),
                        this._maybeUpdateThumbnail(a)
                },
                _onUpload: function (a) {
                    var b = this._parent.prototype._onUpload.apply(this, arguments);
                    return this._templating.showSpinner(a),
                        b
                },
                _onUploadChunk: function (a, b) {
                    this._parent.prototype._onUploadChunk.apply(this, arguments),
                        b.partIndex > 0 && this._templating.allowPause(a)
                },
                _onCancel: function (a) {
                ...
                _onBeforeAutoRetry: function (a) {
                    ...
                    this._parent.prototype._onBeforeAutoRetry.apply(this, arguments),
                        this._showCancelLink(a),
                        this._options.retry.showAutoRetryNote && (b = this._autoRetries[a] + 1,
                            c = this._options.retry.maxAutoAttempts,
                            d = this._options.retry.autoRetryNote.replace(/\{retryNum\}/g, b),
                            d = d.replace(/\{maxAuto\}/g, c),
                            this._templating.setStatusText(a, d),
                            qq(this._templating.getFileContainer(a)).addClass(this._classes.retrying))
                },
                _onBeforeManualRetry: function (a) {
                    return this._parent.prototype._onBeforeManualRetry.apply(this, arguments) ? (this._templating.resetProgress(a),
                        qq(this._templating.getFileContainer(a)).removeClass(this._classes.fail),
                        this._templating.setStatusText(a),
                        this._templating.showSpinner(a),
                        this._showCancelLink(a),
                        !0) : (qq(this._templating.getFileContainer(a)).addClass(this._classes.retryable),
                            !1)
                },
                ...
                _sendDeleteRequest: function (a) {
                    this._templating.hideDeleteButton(a),
                        this._templating.showSpinner(a),
                        this._templating.setStatusText(a, this._options.deleteFile.deletingStatusText),
                ...
                _addToList: function (a, b, c) {
                    var d, e = 0;
                    this._options.display.prependFiles && (this._totalFilesInBatch > 1 && this._filesInBatchAddedToUi > 0 && (e = this._filesInBatchAddedToUi - 1),
                        d = {
                            index: e
                        }),
                        c || (this._options.disableCancelForFormUploads && !qq.supportedFeatures.ajaxUploading && this._templating.disableCancel(),
                            this._options.multiple || (this._handler.cancelAll(),
                                this._clearList())),
                        this._templating.addFile(a, this._options.formatFileName(b), d),
                ...
                _displayFileSize: function (a, b, c) {
                    ...
                    d >= 0 && (void 0 !== b && void 0 !== c && (e = this._formatProgress(b, c)),
                        this._templating.updateSize(a, e))
                },
                _formatProgress: function (a, b) {
                    ...
                    return c("{percent}", Math.round(a / b * 100)),
                        c("{total_size}", this._formatSize(b)),
                        d
                },
                _controlFailureTextDisplay: function (a, b) {
                    ...
                    c = this._options.failedUploadTextDisplay.mode,
                        ...
                        "custom" === c ? (f = b[e],
                            ...
                            this._templating.setStatusText(a, g || f),
                            this._options.failedUploadTextDisplay.enableTooltip && this._showTooltip(a, f)) : "default" === c ? this._templating.setStatusText(a, this._options.text.failUpload) : "none" !== c && this.log("failedUploadTextDisplay.mode value of '" + c + "' is not valid", "warn")
                },
                ...
                _addCannedFile: function () {
                    ...
                    return this._addToList(a, this.getName(a), !0),
                        this._templating.hideSpinner(a),
                        this._templating.hideCancel(a),
                        this._markFileAsSuccessful(a),
                        a
                }
            }
    }(),
    qq.FineUploader = function (a, b) {
        "use strict";
        this._parent = b ? qq[b].FineUploaderBasic : qq.FineUploaderBasic,
            ...
            !qq.supportedFeatures.uploading || this._options.cors.expected && !qq.supportedFeatures.uploadCors ? this._templating.renderFailure(this._options.messages.unsupportedBrowser) : (this._wrapCallbacks(),
                ...
                this._options.paste.targetElement && this._options.paste.promptForName && (qq.PasteSupport ? this._setupPastePrompt() : qq.log("Paste support module not found.", "info")),
                this._totalFilesInBatch = 0,
                this._filesInBatchAddedToUi = 0)
    }
    ,
    ...
    qq.Templating = function (a) {
        ...
        function b() {
            ...
            if (y("Parsing template"),
                null == N.templateIdOrEl)
                throw new Error("You MUST specify either a template element or ID!");
            if (qq.isString(N.templateIdOrEl)) {
                if (a = document.getElementById(N.templateIdOrEl),
                    null === a)
            ...
            if (b = qq.trimStr(b),
                ...
                d.appendChild(qq.toElement(b)),
                N.button && (f = qq(d).getByClass(O.button)[0],
                    f && qq(f).remove()),
                qq.DragAndDrop && qq.supportedFeatures.fileDrop || (i = qq(d).getByClass(O.dropProcessing)[0],
                    i && qq(i).remove()),
                g = qq(d).getByClass(O.drop)[0],
                g && !qq.DragAndDrop && (qq.log("DnD module unavailable.", "info"),
                    qq(g).remove()),
                g && !qq.supportedFeatures.fileDrop && qq(g).hasAttribute(K) && qq(g).css({
                    display: "none"
                }),
                h = qq(d).getByClass(O.thumbnail)[0],
                E ? h && (M = parseInt(h.getAttribute(I)),
                    M = M > 0 ? M : null,
                    F = qq(h).hasAttribute(J)) : h && qq(h).remove(),
                E = E && h,
                z = qq(d).getByClass(O.editFilenameInput).length > 0,
                A = qq(d).getByClass(O.retry).length > 0,
                c = qq(d).getByClass(O.list)[0],
                null == c)
                throw new Error("Could not find the file list container in the template!");
            return e = c.innerHTML,
                c.innerHTML = "",
                y("Template parsing complete"),
            {
        ...
        function e(a, b) {
            var c = D
                , d = c.firstChild;
            b > 0 && (d = qq(c).children()[b].nextSibling),
                c.insertBefore(a, d)
        }
        function f(a) {
        ...
        function t(a, b) {
            var c = i(a);
            c && !qq(c).hasClass(O.progressBar) && (c = qq(c).getByClass(O.progressBar)[0]),
                c && qq(c).css({
                    width: b + "%"
                })
        }
        function u() {
            var a = N.placeholders.thumbnailNotAvailable
                , b = N.placeholders.waitingForThumbnail
                , c = {
                    maxSize: M,
                    scale: F
                };
            E && (a ? N.imageGenerator.generate(a, new Image, c).then(function (a) {
                ...
                b ? N.imageGenerator.generate(b, new Image, c).then(function (a) {
                    R.success(a)
                }, function () {
                    R.failure(),
        ...
        function v(a) {
            R.then(function (b) {
                x(b, a),
                    null == a.getAttribute("src") && (a.src = b.src,
                        s(a))
            }, function () {
                r(a)
            })
        ...
        qq.extend(N, a),
            y = N.log,
            C = N.containerEl,
            E = void 0 !== N.imageGenerator,
            B = b(),
            u(),
            qq.extend(this, {
                render: function () {
                    y("Rendering template in DOM."),
                        C.innerHTML = B.template,
                        r(p()),
                        D = N.fileContainerEl || d(C, O.list),
                        y("Template rendering complete")
                },
                ...
                addFile: function (a, b, c) {
                    var f = qq.toElement(B.fileTemplate)
                        , j = d(f, O.file);
                    qq(f).addClass(H + a),
                        j && qq(j).setText(b),
                        f.setAttribute(G, a),
                        c ? e(f, c.index) : D.appendChild(f),
                        r(i(a)),
                        r(l(a)),
                        r(m(a)),
                        r(n(a)),
                ...
                uploadPaused: function (a) {
                    this.setStatusText(a, N.text.paused),
                        this.allowContinueButton(a),
                        r(j(a))
                },
                ...
                generatePreview: function (a, b) {
                    ...
                    if (qq.supportedFeatures.imagePreviews) {
                        if (P[a] = new qq.Promise,
                            c)
                            return v(c),
                                N.imageGenerator.generate(b, c, d).then(function () {
                                    s(c),
                                        P[a].success()
                                }, function () {
                                    P[a].failure(),
                                        N.placeholders.waitUntilUpdate || w(a, c)
                                })
                    } else
                        c && v(c)
                },
                updateThumbnail: function (a, b, c) {
                    ...
                    if (d) {
                        if (b)
                            return c && v(d),
                                N.imageGenerator.generate(b, d, e).then(function () {
                                    s(d)
                                }, function () {
                                    w(a, d)
                                });
    ...
    qq.UploadHandlerForm = function (a, b) {
        ...
        function c(a, b) {
            ...
            try {
                var d = b.contentDocument || b.contentWindow.document
                    , e = d.body.innerHTML;
                k("converting iframe's innerHTML to JSON"),
                    k("innerHTML = " + e),
                    e && e.match(/^<pre/i) && (e = d.body.firstChild.firstChild.nodeValue),
                    c = l.parseJsonResponse(a, e)
            } catch (f) {
                k("Error when attempting to parse form upload response (" + f.message + ")", "error"),
                    c = {
                        success: !1
                    }
            }
        ...
        var e = []
            ...
            , k = b.log
            , l = {};
        qq.extend(this, new qq.UploadHandlerFormApi(l, {
            fileState: e,
            ...
            qq.extend(this, {
                upload: function (b) {
                    var f, g = e[b].input, i = h(b), m = l.createIframe(b);
                    if (!g)
                        throw new Error("file with passed id was not added, or already uploaded or canceled");
                    a.onUpload(b, h(b)),
                        f = d(b, m),
                        f.appendChild(g),
                        l.attachLoadEvent(m, function (d) {
                            k("iframe loaded");
                            var e = d ? d : c(b, m);
                            l.detachLoadEvent(b),
                                a.cors.expected || qq(m).remove(),
                                (e.success || !a.onAutoRetry(b, i, e)) && (a.onComplete(b, i, e),
                                    j(b))
                        }),
                        k("Sending upload request for " + b),
                        f.submit(),
                        qq(f).remove()
                }
            })
    ...
    qq.UploadHandlerXhr = function (a, b) {
        ...
        function d(b, c, d) {
            var e = I(b)
                , f = G(b);
            c[a.chunking.paramNames.partIndex] = d.part,
                c[a.chunking.paramNames.partByteOffset] = d.start,
                c[a.chunking.paramNames.chunkSize] = d.size,
                c[a.chunking.paramNames.totalParts] = d.count,
                c[a.totalFileSizeName] = e,
                O && (c[a.filenameParam] = f)
        }
        function e(b) {
        ...
        function f(b, c, d, e) {
            var f = new FormData
                ...
                , j = G(e)
                , k = I(e);
            return b[a.uuidName] = H(e),
                b[a.filenameParam] = j,
                O && (b[a.totalFileSizeName] = k),
                a.paramsInBody || (O || (b[a.inputName] = j),
                    i = qq.obj2url(b, h)),
                c.open(g, i, !0),
                a.cors.expected && a.cors.sendCredentials && (c.withCredentials = !0),
                O ? (a.paramsInBody && qq.obj2FormData(b, f),
                    f.append(a.inputName, d),
                    f) : d
        }
        function g(b, c) {
            var d = a.customHeaders
                , e = K[b].file || K[b].blobData.blob;
            c.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                c.setRequestHeader("Cache-Control", "no-cache"),
                O || (c.setRequestHeader("Content-Type", "application/octet-stream"),
                    c.setRequestHeader("X-Mime-Type", e.type)),
                qq.each(d, function (a, b) {
        ...
        function h(b, c, d) {
            var e = G(b)
                , f = I(b);
            K[b].attemptingResume = !1,
                a.onProgress(b, e, f, f),
                a.onComplete(b, e, c, d),
                K[b] && delete K[b].xhr,
                E(b)
        }
        function i(b) {
            var c, h, i = K[b].remainingChunkIdxs[0], k = P.getChunkData(b, i), l = P.createXhr(b), m = I(b), n = G(b);
            void 0 === K[b].loaded && (K[b].loaded = 0),
                N && K[b].file && t(b, k),
                l.onreadystatechange = s(b, l),
                l.upload.onprogress = function (c) {
                ...
                ,
                a.onUploadChunk(b, n, P.getChunkDataForCallback(k)),
                h = a.paramsStore.getParams(b),
                d(b, h, k),
                K[b].attemptingResume && e(h),
                c = f(h, l, k.blob, b),
                g(b, l),
                J("Sending chunked upload request for item " + b + ": bytes " + (k.start + 1) + "-" + k.end + " of " + m),
                l.send(c)
        }
        function j(a, b, c) {
            var d = P.getChunkData(a, b)
                , e = d.size
                , f = c - e
                , g = I(a)
                , h = d.count
                , i = K[a].initialRequestOverhead
                , j = f - i;
            return K[a].lastRequestOverhead = f,
                0 === b ? (K[a].lastChunkIdxProgress = 0,
                    K[a].initialRequestOverhead = f,
                    K[a].estTotalRequestsSize = g + h * f) : K[a].lastChunkIdxProgress !== b && (K[a].lastChunkIdxProgress = b,
                        K[a].estTotalRequestsSize += j),
                K[a].estTotalRequestsSize
        }
        function k(a) {
            return O ? K[a].lastRequestOverhead : 0
        }
        function l(b, c, d) {
            var e = K[b].remainingChunkIdxs.shift()
                , f = P.getChunkData(b, e);
            K[b].attemptingResume = !1,
                K[b].loaded += f.size + k(b),
                a.onUploadChunkSuccess(b, P.getChunkDataForCallback(f), c, d),
                K[b].remainingChunkIdxs.length > 0 ? i(b) : (N && u(b),
                    h(b, c, d))
        }
        function m(a, b) {
        ...
        function n(a, b) {
            var c;
            try {
                J(qq.format("Received response status {} with body: {}", b.status, b.responseText)),
                    c = qq.parseJson(b.responseText),
                    void 0 !== c.newUuid && F(a, c.newUuid)
            } catch (d) {
                J("Error when attempting to parse xhr response text (" + d.message + ")", "error"),
                    c = {}
            }
            return c
        }
        function o(a) {
            J("Server has ordered chunking effort to be restarted on next attempt for item ID " + a, "error"),
                N && (u(a),
                    K[a].attemptingResume = !1),
                K[a].remainingChunkIdxs = [],
                delete K[a].loaded,
                delete K[a].estTotalRequestsSize,
                delete K[a].initialRequestOverhead
        }
        function p(a) {
            K[a].attemptingResume = !1,
                J("Server has declared that it cannot handle resume for item ID " + a + " - starting from the first chunk", "error"),
                o(a),
                Q.upload(a, !0)
        }
        function q(b, c, d) {
            var e = G(b);
            a.onAutoRetry(b, e, c, d) || h(b, c, d)
        }
        function r(a, b) {
            var c, d = K[a], e = d && d.attemptingResume, f = d && d.paused;
            d && !f && (J("xhr - server response received for " + a),
                J("responseText = " + b.responseText),
                c = n(a, b),
                m(b, c) ? (c.reset && o(a),
                    e && c.reset ? p(a) : q(a, c, b)) : M ? l(a, c, b) : h(a, c, b))
        }
        function s(a, b) {
            return function () {
        ...
        function t(b, c) {
            var d = H(b)
                , e = K[b].loaded
                , f = K[b].initialRequestOverhead
                , g = K[b].estTotalRequestsSize
                , h = w(b)
                , i = d + L + c.part + L + e + L + f + L + g
        ...
        function w(b) {
            ...
            return c = "qqfilechunk" + L + encodeURIComponent(d) + L + e + L + f,
                void 0 !== D && (c += L + D),
                c
        }
        function x(a, b) {
            var c;
            for (c = P.getTotalChunks(a) - 1; c >= b; c -= 1)
                K[a].remainingChunkIdxs.unshift(c);
            i(a)
        }
        function y(a, b, c, d) {
            c = d.part,
                K[a].loaded = d.lastByteSent,
                K[a].estTotalRequestsSize = d.estTotalRequestsSize,
                K[a].initialRequestOverhead = d.initialRequestOverhead,
                K[a].attemptingResume = !0,
                J("Resuming " + b + " at partition index " + c),
                x(a, c)
        }
        function z(b, c, d) {
            var e, f = G(b), g = P.getChunkData(b, c.part);
            e = a.onResume(b, f, P.getChunkDataForCallback(g)),
                e instanceof qq.Promise ? (J("Waiting for onResume promise to be fulfilled for " + b),
                    e.then(function () {
                        y(b, f, d, c)
                    }, function () {
                        J("onResume promise fulfilled - failure indicated.  Will not resume."),
                            x(b, d)
                    })) : e !== !1 ? y(b, f, d, c) : (J("onResume callback returned false.  Will not resume."),
                        x(b, d))
        }
        function A(a, b) {
            var c, d = 0;
            K[a].remainingChunkIdxs && 0 !== K[a].remainingChunkIdxs.length ? i(a) : (K[a].remainingChunkIdxs = [],
                N && !b && K[a].file ? (c = v(a),
                    c ? z(a, c, d) : x(a, d)) : x(a, d))
        }
        function B(b) {
            var c, d, e, h = K[b].file || K[b].blobData.blob, i = G(b);
            K[b].loaded = 0,
                c = P.createXhr(b),
                c.upload.onprogress = function (c) {
                    c.lengthComputable && (K[b].loaded = c.loaded,
                        a.onProgress(b, i, c.loaded, c.total))
                }
                ,
                c.onreadystatechange = s(b, c),
                d = a.paramsStore.getParams(b),
                e = f(d, c, h, b),
                g(b, c),
                J("Sending upload request for " + b),
                c.send(e)
        }
        function C(b, c) {
            var d = G(b);
            Q.isValid(b) && (a.onUpload(b, d),
                M ? A(b, c) : B(b))
        }
        var D, E = b.onUploadComplete, F = b.onUuidChanged, G = b.getName, H = b.getUuid, I = b.getSize, J = b.log, K = [], L = "|", M = a.chunking.enabled && qq.supportedFeatures.chunking, N = a.resume.enabled && M && qq.supportedFeatures.resume, O = a.forceMultipart || a.paramsInBody, P = {}, Q = this;
        D = c(),
            qq.extend(this, new qq.UploadHandlerXhrApi(P, {
                fileState: K,
                chunking: M ? a.chunking : null
            }, {
                onUpload: C,
                onCancel: a.onCancel,
                onUuidChanged: F,
            ...
            qq.override(this, function (b) {
                return {
                    ...
                    getResumableFilesData: function () {
                        var b = []
                            , c = [];
                        return M && N ? (b = qq.getCookieNames(void 0 === D ? new RegExp("^qqfilechunk\\" + L + ".+\\" + L + "\\d+\\" + L + a.chunking.partSize + "=") : new RegExp("^qqfilechunk\\" + L + ".+\\" + L + "\\d+\\" + L + a.chunking.partSize + "\\" + L + D + "=")),
                            qq.each(b, function (a, b) {
                                var d = b.split(L)
                                    , e = qq.getCookie(b).split(L);
                                c.push({
    ...
    qq.DragAndDrop = function (a) {
        ...
        function b(a, b) {
            ...
            i.callbacks.dropLog("Grabbed " + a.length + " dropped files."),
                b.dropDisabled(!1),
                i.callbacks.processingDroppedFilesComplete(c, b.getElement())
        }
        function c(a) {
            ...
            return a.isFile ? a.file(function (a) {
                ...
                i.callbacks.dropLog("Problem parsing '" + a.fullPath + "'.  FileError code " + b.code + ".", "error"),
                    d.failure()
            }) : a.isDirectory && (b = a.createReader(),
        ...
        function d(a, b) {
            var d = []
                , e = new qq.Promise;
            return i.callbacks.processingDroppedFiles(),
                b.dropDisabled(!0),
                a.files.length > 1 && !i.allowMultipleItems ? (i.callbacks.processingDroppedFilesComplete([]),
                    i.callbacks.dropError("tooManyFilesError", ""),
                    b.dropDisabled(!1),
                    e.failure()) : (m = [],
        ...
        function e(a) {
            var c = new qq.UploadDropZone({
                ...
                element: a,
                onEnter: function (b) {
                    qq(a).addClass(i.classes.dropActive),
                        b.stopPropagation()
                },
                ...
                onDrop: function (a) {
                    d(a.dataTransfer, c).done(function () {
                        b(m, c)
                    })
                }
            });
            ...
            qq.each(a, function (b, c) {
                ...
                n.attach(document, j, function () {
                    qq.each(i.dropZoneElements, function (a, b) {
                        qq(b).hasAttribute(k) && qq(b).hide(),
                            qq(b).removeClass(i.classes.dropActive)
                    })
                })
        }
    ...
    qq.UploadDropZone = function (a) {
        ...
        function d(a) {
            ...
            return b = qq.ie10() || qq.ie11() ? !0 : "none" !== c.effectAllowed,
        ...
        function f() {
            function a() {
                b = document.createEvent("Event"),
                    b.initEvent(h.HIDE_ZONES_EVENT_NAME, !0, !0)
            }
            var b;
        ...
        qq.extend(d, a),
            ...
            qq.extend(this, {
                sendDelete: function (a, b, e) {
                    var f = e || {};
                    d.log("Submitting delete file request for " + a),
                        "DELETE" === d.method ? c.initTransport(a).withPath(b).withParams(f).send() : (f[d.uuidParamName] = b,
    ...
    function () {
        ...
        f.prototype.render = function (a, b) {
            ...
            h && !i ? i = g * h / f << 0 : i && !h ? h = f * i / g << 0 : (h = f,
                i = g),
                j && h > j && (h = j,
                    i = g * h / f << 0),
                k && i > k && (i = k,
            ...
            "img" === o ? a.src = c(this.srcImage, m, l) : "canvas" === o && d(this.srcImage, a, m, l),
    ...
    qq.ImageGenerator = function (a) {
        ...
        function g(a) {
            ...
            return e.href = a,
                ...
                d = e.port,
                c = e.hostname,
                b.toLowerCase() !== window.location.protocol.toLowerCase() ? !0 : c.toLowerCase() !== window.location.hostname.toLowerCase() ? !0 : d === window.location.port || qq.ie() ? !1 : !0
        }
        function h(b, c) {
            b.onload = function () {
                b.onload = null,
                ...
                b.onerror = function () {
                    b.onload = null,
                        b.onerror = null,
                        a("Problem drawing thumbnail!", "error"),
        ...
        function j(d, e) {
            var f = b(d) || c(d);
            return b(d) ? h(d, e) : c(d) ? i(d, e) : (e.failure(d),
                a(qq.format("Element container of type {} is not supported!", d.tagName), "error")),
                f
        }
        function k(b, c, d) {
            var e = new qq.Promise
                ...
                , h = function () {
                    c.onerror = null,
                        c.onload = null,
                        a("Could not render preview, file may be too large!", "error"),
                        e.failure(c, "Browser cannot render image!")
                };
            return f.isPreviewable().then(function (d) {
                var f = new qq.Exif(b, a)
                    , i = new MegaPixImage(b, h);
        ...
        qq.extend(this, {
            generate: function (b, c, d) {
                return qq.isString(b) ? (a("Attempting to update thumbnail based on server response."),
                    n(b, c, d || {})) : (a("Attempting to draw client-side image preview."),
                        k(b, c, d || {}))
            }
        }),
            this._testing = {},
            this._testing.isImg = b,
            this._testing.isCanvas = c,
            this._testing.isCrossOrigin = g,
    ...
    qq.Exif = function (a, b) {
        ...
        function c(a) {
            for (var b = 0, c = 0; a.length > 0;)
                b += parseInt(a.substring(0, 2), 16) * Math.pow(2, c),
        ...
        function d(b, c) {
            ...
            return void 0 === e && (e = 2,
                f = new qq.Promise),
                qq.readBlobToHex(a, e, 4).then(function (a) {
        ...
        function j(a, b) {
            ...
            return qq.each(b, function (b, g) {
                ...
                return n >= 0 && (i = l[m].name,
                    j = l[m].bytes,
                    h = g.slice(d, d + 2 * j),
                    f[i] = a ? c(h) : parseInt(h, 16),
                    e.splice(n, 1)),
                    0 === e.length ? !1 : void 0
            }),
                f
        ...
        qq.extend(this, {
            parse: function () {
                var c = new qq.Promise
                    , d = function (a) {
                        b(qq.format("EXIF header parse failed: '{}' ", a)),
                            c.failure(a)
                    };
                return e().then(function (e) {
                    b(qq.format("Moving forward with EXIF header parsing for '{}'", void 0 === a.name ? "blob" : a.name)),
                        f(e).then(function (a) {
                            b(qq.format("EXIF Byte order is {} endian", a ? "little" : "big")),
                                g(e, a).then(function (f) {
                                    b(qq.format("Found {} APP1 directory entries", f)),
                                        h(e, f).then(function (d) {
                                            var e = i(d)
                                                , f = j(a, e);
                                            b("Successfully parsed some EXIF tags"),
                                                c.success(f)
                                        }, d)
                                }, d)
                        }, d)
            ...
            this._testing = {},
            this._testing.parseLittleEndian = c
    }
    ,
                ...
                return b(qq.format("Attempting to determine if {} can be rendered in this browser", g)),
                    qq.readBlobToHex(a, 0, 4).then(function (a) {
                        qq.each(d, function (b, d) {
                            return c(d, a) ? (("image/tiff" !== b || qq.safari()) && (f = !0,
                                e.success(b)),
                                !1) : void 0
                        }),
    ...
    qq.ImageValidation = function (a, b) {
        ...
        function d() {
            ...
            return new qq.Identify(a, b).isPreviewable().then(function () {
                ...
                e ? (d.onerror = function () {
                    b("Cannot determine dimensions for image.  May be too large.", "error"),
                        c.failure()
                }
                    ,
                    d.onload = function () {
        ...
        this.validate = function (a) {
            ...
            return b("Attempting to validate image."),
                c(a) ? d().then(function (b) {
                    var c = e(a, b);
    ...
    qq.Session = function (a) {
        ...
        function c(a, c, e, f) {
            var g = !1;
            c = c && b(a),
                c && qq.each(a, function (a, b) {
                    if (null == b.uuid)
                        g = !0,
                            d.log(qq.format("Session response item {} did not include a valid UUID - ignoring.", a), "error");
                    else if (null == b.name)
                        g = !0,
                            d.log(qq.format("Session response item {} did not include a valid name - ignoring.", a), "error");
                    else
                        try {
                            return d.addFileRecord(b),
                                !0
                        } catch (c) {
                            g = !0,
                                d.log(c.message, "error")
                        }
                    return !1
                }),
        ...
        function b(a, b, c) {
            ...
            if (null != b.responseText)
                try {
                    ...
                    d.log("Problem parsing session response: " + f.message, "error"),
                        c = !0
                }
            d.onComplete(e, !c, b)
        }
        ...
        qq.extend(d, a),
            ...
            qq.extend(this, {
                queryServer: function () {
                    ...
                    a.qqtimestamp = (new Date).getTime(),
                        d.log("Session query request."),
                        c.initTransport("sessionRefresh").withParams(a).send()
                }
            })
    }
    ,
    ...
    qq.FileButtonsClickHandler = function (a) {
        ...
        function b(a, b) {
            qq.each(e, function (c, e) {
                ...
                return d.templating["is" + g](a) ? (f = d.templating.getFileId(a),
                    qq.preventDefault(b),
        ...
        qq.extend(d, a),
            d.eventType = "click",
            d.onHandled = b,
            d.attachTo = d.templating.getFileList(),
    ...
    qq.FilenameClickHandler = function (a) {
        ...
        qq.extend(d, a),
            d.eventType = "click",
            d.onHandled = b,
            qq.extend(this, new qq.FilenameEditHandler(d, c))
    }
    ,
    qq.FilenameInputFocusInHandler = function (a, b) {
        ...
        b || (b = {}),
            ...
            d.onHandled = c,
            qq.extend(d, a),
            qq.extend(this, new qq.FilenameEditHandler(d, b))
    }
    ,
    qq.FilenameInputFocusHandler = function (a) {
        ...
        a.eventType = "focus",
            a.attachTo = null,
            qq.extend(this, new qq.FilenameInputFocusInHandler(a, {}))
    }
    ,
    qq.FilenameEditHandler = function (a, b) {
        ...
        function e(a, b) {
            var c, e = a.value;
            void 0 !== e && qq.trimStr(e).length > 0 && (c = d(b),
                void 0 !== c && (e = e + "." + c),
                h.onSetName(b, e)),
                h.onEditingStatusChange(b, !1)
        }
        function f(a, c) {
        ...
        qq.extend(h, a),
            h.attachTo = h.templating.getFileList(),
            qq.extend(this, new qq.UiEventHandler(h, b)),
            qq.extend(b, {
                handleFilenameEdit: function (a, b, d) {
                    var e = h.templating.getEditInput(a);
                    h.onEditingStatusChange(a, !0),
                        e.value = c(a),
                        d && e.focus(),
                        f(e, a),
                        g(e, a)
    ...
    function (a) {
        ...
        function c(a) {
            var b = f("uploaderType")
                , c = f("endpointType");
            return b ? (b = b.charAt(0).toUpperCase() + b.slice(1).toLowerCase(),
                c ? new qq[c]["FineUploader" + b](a) : new qq["FineUploader" + b](a)) : c ? new qq[c].FineUploader(a) : new qq.FineUploader(a)
        }
        function d(a, b) {
            var c = l.data("fineuploader");
            return b ? (void 0 === c && (c = {}),
                c[a] = b,
                l.data("fineuploader", c),
                void 0) : void 0 === c ? null : c[a]
        }
        function e(a) {
            return d("uploader", a)
        }
            ...
            return d = void 0 === c ? "basic" !== b.uploaderType ? {
                ...
                a.each(b, function (b, c) {
                    a.inArray(b, m) >= 0 ? f(b, c) : c instanceof a ? d[b] = c[0] : a.isPlainObject(c) ? (d[b] = {},
                        h(c, d[b])) : a.isArray(c) ? (e = [],
                            a.each(c, function (b, c) {
                                var d = {};
                                c instanceof a ? a.merge(e, c) : a.isPlainObject(c) ? (h(c, d),
                                    e.push(d)) : e.push(c)
                            }),
                            d[b] = e) : d[b] = c
                }),
    ...
    function (a) {
        ...
        function f(b, c) {
            ...
            return d = void 0 === c ? {} : c,
                a.each(b, function (b, c) {
                    c instanceof a ? d[b] = c[0] : a.isPlainObject(c) ? (d[b] = {},
                        f(c, d[b])) : a.isArray(c) ? (e = [],
                            a.each(c, function (b, c) {
