...
!function (t, i) {
    ...
    function n() {
        ...
        i.length > 0 && t(document).on("quickView.product_attributes_changed", function (a) {
            if (a.changedData && a.changedData.pictureDefaultSizeUrl) {
                ...
                "true" === i.attr("data-isCloudZoomAvailable") ? (e = e.substring(1, e.length - 9),
                    t('.quickViewWindow .cloudzoom-gallery[href*="' + e + '"]').click()) : t(".quickViewWindow .gallery .picture img").attr("src", e)
            }
        })
    }
    function c() {
    ...
    function r(i) {
        ...
        if (void 0 != r) {
            ...
            t.ajax({
                ...
                t(window).height() < u ? t(".quickView").css("top", t(document).scrollTop() + 10) : t(".quickView").css("top", d.top - u / 4),
                    n(),
                    c(),
                    t.event.trigger({
    ...
    function s() {
        ...
        if (i.length > 0) {
            ...
            o.wrapper.addClass("quickView"),
                t(document).on("click", ".k-overlay", function () {
                    o.close()
                })
        }
    }
    ...
    t(document).on("nopQuickViewDataShownEvent", function () {
        ...
        t(i).hasClass("nopAjaxCartProductVariantAddToCartButton") || (t(i).prop("onclick", null).off("click"),
        ...
        t(document).ready(function () {
            if (!(i.isMobile() || !i.isMobile() && i.getViewPort().width <= 768)) {
                ...
                if ("" !== e) {
                    var o = p(e);
                    d(e, o),
                        t(document).on("nopAjaxCartProductAddedToCartEvent nopAjaxCartProductAddedToWishlistEvent", function () {
                            a()
                        }),
